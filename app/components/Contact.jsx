...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "cf8d5064-8a09-45c0-b51d-3b804e4b0d60");
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      className='text-center text-5xl font-Ovo'>get in touch</motion.h2>
        ...
        className="text-center max-w-2xl mx-auto mt-5 font-Ovo">
          ...
          questions, comments, or feedback, please use the 
          form below.</motion.p>
          ...
          onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            rows='6' placeholder='enter yoyr message' required
            ...
            type='submit'
            className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 sark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'
